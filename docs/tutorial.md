# AIly tutorial chapters

| # | Id | Title | Required | Gate |
|---|---|---|---|---|
| 0 | meet | Meet AIly | yes | — |
| 1 | first_target | First Target | yes | ≥1 target |
| 2 | capacity | Capacity | yes | weekly hours set |
| 3 | attention | Attention map | no | usage permission |
